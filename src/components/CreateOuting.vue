  ...
  data: () => {
    return {
             ...
             formGroup: [
               ...
               {title: "Quoi ?",
                 fields: [
                   {label: "City", type: "text", name:"", value: ""},
                   {label: "Zip Code", type: "text", name:"", value: ""},
                   {label: "County", type: "text", name:"", value: ""},
                   {label: "State", type: "text", name:"", value: ""},]},
                {title: "Où ?",
                 fields: [
                   {label: "City", type: "text", name:"", value: ""},
                   {label: "Zip Code", type: "text", name:"", value: ""},
               ...
               {title: "Valider",
                 fields: [
                   {label: "Academic qualification", type: "text", name:"", value: ""},
                   {label: "College Attended", type: "text", name:"", value: ""},
                   {label: "Year of completion", type: "text", name:"", value: ""},]},
                ]}},
